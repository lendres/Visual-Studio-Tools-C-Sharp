...
namespace Visual_Studio_Tools_C_Sharp
{
	...
	[Guid(VSToolsPackage.PackageGuidString)]
	...
	public sealed class VSToolsPackage : AsyncPackage
	{
		...
		/// </summary>
		public const string PackageGuidString = "429c06a7-bbbe-4847-8f3f-ad77cd5ffd15";
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
		    ...
		    await CPointer.InitializeAsync(this);
		    await ReverseEquals.InitializeAsync(this);
		    await KeyboardShortCuts.InitializeAsync(this);
        }
